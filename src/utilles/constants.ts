...
const questionsNameTopic: string[] = data.quizzes.map(
 ...
 const RESTART_EVENT = 'playAgain';
  ...
  export{
    questionsNameTopic,starterSvgPath,forceUpdate,
    questionAmounts,STORAGE_TOPIC,RESTART_EVENT,STORAGE_RESULT,
    STORAGE_ANSWERS,STORAGE_CHECKED,STORAGE_SIGNAL,STORAGE_QUESTION,STORAGE_SHOW,STORAGE_SCORE,STORAGE_THEME};